    ...
    for word in words_list:
        ...
        for letter in word:
            if letter not in punctuations:
                word_without_punctuations += letter
        
        #print(word_without_punctuations)
        if word_without_punctuations not in uninteresting_words:
            if word_without_punctuations.lower() not in frequencies:
                frequencies[word_without_punctuations.lower()] = 0
            frequencies[word_without_punctuations.lower()] += 1
